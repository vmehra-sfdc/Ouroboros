...
@Import({ TestControllerConfig.class, GossipSnoopConfig.class, TestCfg.class,
         GossipHeartbeatAndDiscoveryConfig.class, ClusterTestCfg.class })
public class ClusterControllerCfg {
    private final static Logger log = LoggerFactory.getLogger(ClusterControllerCfg.class.getCanonicalName());
