 ...
 * <ul>
 * <li>"Split-Ordered Lists - Lock-free Resizable Hash Tables" by Ori Shalev Tel
 ...
 * algorithm as {@link LockFreeOrderedList}. Elements are sorted by
 ...
 * Elements are wrapped by {@link HashLinkNode} before stored into set.
 * 
 * @author Zhi Gan
 * 
 * @param <E>
...
public class LockFreeSet<E> implements Set<E> {
         ...
         *            start pos
         * @param hash
         *            hash value of parameter <code>o</code>. It's used to save time
         *            for regenerating hash.
