...
public class LockFreeOrderedList<E> extends LockFreeList<E> {
    ...
    /**
     * Creates a <tt>LockfreeList</tt> initially containing the elements of the
    ...
    private ListStateHolder<E> findByObject(Object o,
                                            AtomicMarkableReference<Entry<E>> start,
                                            ListStateHolder<E> holder) {
        ...
        try_again: while (true) {
            ...
            while (true) {
                ...
                Comparable<Object> cKey = (Comparable<Object>) cur.element;
