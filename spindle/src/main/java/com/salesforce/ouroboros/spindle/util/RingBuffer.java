...
import static com.salesforce.ouroboros.spindle.util.ConcurrentLinkedHashMap.ceilingNextPowerOfTwo;
...
public final class RingBuffer<E> extends AtomicReferenceArray<E> {
     ...
     *            the actual size is the closest power-of-two greater than the
     *            estimated capacity
     * @param threshold
     *            the threshold size before a drain is attempted
     * @param sink
     *            the handler to drain elements to
     */
     ...
     * {@link Sink}. This operation may be more efficient than repeatedly
     * polling this queue.
     */
    @GuardedBy("lock")
    public void drain() {
